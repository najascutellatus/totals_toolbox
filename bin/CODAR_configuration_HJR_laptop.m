...
conf.QC.timespan=12;
conf.QC.stuck.resolution=0.01;
conf.QC.stuck.num=3;
conf.QC.gradient.threshold=18/3600;
    ...
    switch regName
        case 'MARA'
            switch domain
                ...
                case 'lr'
                    conf.Radials.Types = {'RDLi', 'RDLi', 'RDLm', 'RDLm', 'RDLm', 'RDLm', 'RDLm', 'RDLm', 'RDLm', 'RDLm', 'RDLm', 'RDLm', 'RDLm', 'RDLm', 'RDLi', 'RDLm','RDLm'}; 
...
switch regName
    case 'MARA'
        switch domain
            case 'sr'
                conf.Radials.MaskDir = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/mask_files/25MHz_1kmMask.txt'];% MASK FILE
                ...
                conf.Totals.GridFile = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/grid_files/old_grids/NY_1kmgrid.txt']; % GRID FILE
            ...
            case 'mr'
                conf.Radials.MaskDir = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/mask_files/BPU_2km_extendedMask.txt'];% MASK FILE
                ...
                conf.Totals.FilePrefix = strcat('tuv_',conf.Totals.DomainName,'_');
                conf.Totals.GridFile = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/grid_files/OI_2km_Grid.txt']; % GRID FILE expanded on September 7 2011
                conf.Totals.MaskFile = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/mask_files/BPU_2km_extendedMask.txt'];
            ...
            case 'lr'
                conf.Radials.MaskDir = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/mask_files/MARACOOS_6kmMask.txt'];
                ...
                conf.Totals.FilePrefix = strcat('tuv_',conf.Totals.DomainName,'_');
                conf.Totals.GridFile = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/grid_files/OI_6km_Grid.txt'];
                conf.Totals.MaskFile = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/mask_files/MARACOOS_6kmMask.txt'];
    ...
    case 'CARA'
        conf.Radials.MaskDir = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/mask_files/PR_coast.mask'];
        conf.Radials.MaxRadSpeed = 150;
        conf.Radials.MonthFlag = false;
        conf.Radials.MonthSeperatorFlag = false;
        conf.Radials.TypeFlag=false;
        ...
        conf.Totals.FilePrefix = strcat('tuv_',conf.Totals.DomainName,'_');
        conf.Totals.GridFile = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/grid_files/UPRM_2km_grid.txt'];
        conf.Totals.MaskFile = ['/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/mask_files/PR_coast.mask'];
    ...
    case 'PLDP'
        ...
        conf.Totals.FilePrefix = strcat('tuv_',conf.Totals.DomainName,'_');
        conf.Totals.GridFile = {'/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/grid_files/PLDP_0.5km_grid.txt',...
            '/Users/hroarty/Documents/MATLAB/HFR_RealTime/totals_toolbox/grid_files/PLDP_1km_grid.txt' };
        conf.Totals.spatthresh = 1.6; %km 1.6
        conf.Totals.tempthresh = 1/24/2-eps; %
        conf.Totals.MaxTotSpeed = 150;
        conf.Totals.cleanTotalsVarargin = {{'GDOP','TotalErrors',1.05}};%1.25
