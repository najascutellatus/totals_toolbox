...
%         'hfrSites.numSites = 1)'];
        ...
        for x = 1:1:length(tCurrent)
            ...
            conf = CODAR_configuration_new(systemType, Sites, pattType, baseDir, saveDir);
            ...
            if newNumRadials > oldNumRadials
                ...
                try
                    ...
                    [procFname] = CODAR_driver_totalsNew(tCurrent(x),conf, systemType);
        ...
        for x = 1:1:length(tCurrent)
            ...
            conf = CODAR_configuration_new(systemType, [], [], baseDir, saveDir);
            ...
            try
                ...
                CODAR_driver_totalsNew(tCurrent(x),conf, systemType);
            catch
