...
%
% Next three lines are throwaways
%line = fgetl ( afid );
%line = fgetl ( afid );
%line = fgetl ( afid );

% r_time = gmt_time - datenum(2001,1,1);
...
% nc_varput ( netcdf_filename, 'time', gmt_time - datenum(2001,1,1), 0, 1 );
...
%
% Data(P) = lon;
% nc_varput ( netcdf_filename, 'lon', Data,0,345 );
% 
% Data(P) = lat;
% nc_varput ( netcdf_filename, 'lat', Data,0,399 );
% 
Data(P) = u;
