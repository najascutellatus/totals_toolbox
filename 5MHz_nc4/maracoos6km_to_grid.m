...
codar_grid_file = 'MARACOOS_6km_CompressNCL.txt';% 
% codar_grid_file ='MidAtlantic_6km.txt'; 
% codar_grid_file = 'MARACOOS_6km_ExtendedGrid.txt';
% codar_grid_file = 'MARACOOS_6km_inertial.txt'; % This is for the inertial calculation done by JOSH
